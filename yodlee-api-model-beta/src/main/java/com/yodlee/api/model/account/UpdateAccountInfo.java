...
public class UpdateAccountInfo extends AbstractAccountInfo {
	...
	public String toString() {
		return "UpdateAccountInfo [accountName=" + accountName + ", container=" + container + ", accountStatus="
				+ accountStatus + ", isEbillEnrolled=" + isEbillEnrolled + ", nickname=" + nickname + ", accountNumber="
				+ accountNumber + ", balance=" + balance + ", includeInNetWorth=" + includeInNetWorth + ", memo=" + memo
				+ ", dueDate=" + dueDate + ", homeValue=" + homeValue + ", amountDue=" + amountDue + ", frequency="
				+ frequency + "]";
	}
}
