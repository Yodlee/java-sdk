...
import com.yodlee.api.model.CreditAcceleratorAccountHolder;
import com.yodlee.api.model.provideraccounts.DataSetInfo;
...
@JsonPropertyOrder({"fullAccountNumber", "fullAccountNumberList", "CONTAINER", "providerAccountId", "accountName", "accountStatus",
		...
		"repaymentPlanType", "guarantor", "lender", "paymentProfile", "autoRefresh", "oauthMigrationStatus", "isReconciliable", "dataset"})
public class CreditAcceleratorAccount extends AbstractCreditAcceleratorAccount {
	...
	private CreditAcceleratorAccountProfile profile;
	...
	@ApiModelProperty(readOnly = true,
					  value = "Holder details of the account."//
							  ...
							  + "</ul>")
	@JsonProperty("holder")
	private List<CreditAcceleratorAccountHolder> holders;
	...
	private CreditAcceleratorPaymentProfile paymentProfile;
	 ...
	 */
	@JsonProperty("holder")
	public List<CreditAcceleratorAccountHolder> getHolders() {
	 ...
	 * @return profile
	 */
	public CreditAcceleratorAccountProfile getProfile() {
		return profile;
	}
	 ...
	 */
	public CreditAcceleratorPaymentProfile getPaymentProfile() {
		return paymentProfile;
	}
	...
	public boolean isReconciliable() {
		return isReconciliable;
	}

	public void setReconciliable(boolean isReconciliable) {
