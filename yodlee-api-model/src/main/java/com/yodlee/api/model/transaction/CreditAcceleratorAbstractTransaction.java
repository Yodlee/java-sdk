...
public abstract class CreditAcceleratorAbstractTransaction extends AbstractModelComponent {
	...
	protected CreditAcceleratorMerchant merchant;
	...
	@ApiModelProperty(readOnly = true, value = "Created date of transaction")
	@JsonProperty("createdDate")
	protected String createdDate;

	@ApiModelProperty(readOnly = true, value = "Last update date and time of transaction")
	 ...
	 * @return merchant
	 */
	public CreditAcceleratorMerchant getMerchant() {
		return merchant;
	}

	public void setMerchant(CreditAcceleratorMerchant merchant) {
