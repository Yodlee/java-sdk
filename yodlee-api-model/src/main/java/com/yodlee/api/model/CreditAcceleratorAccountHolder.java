...
@JsonPropertyOrder({"ownership", "name", "identifier", "gender", "dateOfBirth"})
public class CreditAcceleratorAccountHolder extends AbstractModelComponent {
	...
	@ApiModelProperty(readOnly = true, value = "Holder's date of birth")
