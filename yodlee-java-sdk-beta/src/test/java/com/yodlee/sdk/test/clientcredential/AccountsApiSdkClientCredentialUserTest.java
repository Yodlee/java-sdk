...
public class AccountsApiSdkClientCredentialUserTest extends AbstractSdkClientCredentialUserTestSuite {

	private final AccountsApi accountsApi = new AccountsApi(null);

	public AccountsApiSdkClientCredentialUserTest() {
		accountsApi.setContext(AbstractSdkClientCredentialUserTestSuite.setup());
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\getAccountDetails.csv")
	public void getAccountDetails(String testCaseId, String testCaseName, String accountId, String include,
			String enabled) {
		AccountsApiSdkTest.getAccountDetailsTest(accountsApi, testCaseId, testCaseName, accountId, include);
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\getAccountDetails.csv")
	public void getAccountDetailswithGzip(String testCaseId, String testCaseName, String accountId, String include,
			String enabled) {
		AccountsApiSdkTest.getAccountDetailsTestWithGzipVarargs(accountsApi, testCaseId, testCaseName, accountId,
				include);
	}

	@Test(enabled = false, dataProvider = "feeder")
	@Source("\\Accounts\\getAccountDetailsNeg.csv")
	public void getAccountDetailsNeg(String testCaseId, String testCaseName, String accountId, String include,
			String enabled) {
		AccountsApiSdkTest.getAccountDetailsTest(accountsApi, testCaseId, testCaseName, accountId, include);
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\getAllAccounts.csv")
	public void getAllAccountswithGzip(String testCaseId, String testCaseName, String accountId, String container,
			String include, String providerAccountId, String requestId, String status, String enabled) {
		AccountsApiSdkTest.getAllAccountsTestWithGzipVarargs(accountsApi, testCaseId, testCaseName, accountId, container, include,
				providerAccountId, requestId, status);
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\evaluateAddress.csv")
	public void evaluateAddress(String testCaseId, String testCaseName, String fileName, String enabled) {
		AccountsApiSdkTest.evaluateAddressTest(accountsApi, testCaseId, testCaseName, fileName, enabled);
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\associatedAccounts.csv")
	public void associatedAccounts(String testCaseId, String testCaseName, String providerAccountId, String enabled) {
		AccountsApiSdkTest.getAssociatedAccountsTest(accountsApi, testCaseId, testCaseName, providerAccountId);
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\migrateAccounts.csv")
	public void migrateAccounts(String testCaseId, String testCaseName, String providerAccountId, String enabled) {
		AccountsApiSdkTest.migrateAccountsTest(accountsApi, testCaseId, testCaseName, providerAccountId);
	}
}
