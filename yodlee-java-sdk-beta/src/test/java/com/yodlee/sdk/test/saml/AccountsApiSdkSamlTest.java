...
public class AccountsApiSdkSamlTest extends AbstractSdkSAMLUserTestSuite {

	private final AccountsApi accountsApi = new AccountsApi(null);

	public AccountsApiSdkSamlTest() {
		accountsApi.setContext(AbstractSdkSAMLUserTestSuite.setup());
	}
