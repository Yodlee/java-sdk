...
public class AccountsApiSdkJwtTest extends AbstractSdkJWTUserTestSuite {
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Accounts\\accountBalance.csv")
	public void accountLatestBalance(String testCaseId, String testCaseName, String accountId, String providerAccountId, String enabled) {
		AccountsApiSdkTest.getAccountBalanceTest(accountsApi, testCaseId, testCaseName, accountId, providerAccountId);
	}
}
