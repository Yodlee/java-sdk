...
public class VerificationApiSdkClientCredentialUserTest extends AbstractSdkClientCredentialUserTestSuite {

	private final VerificationApi verificationApi = new VerificationApi(null);

	public VerificationApiSdkClientCredentialUserTest() {
		verificationApi.setContext(AbstractSdkClientCredentialUserTestSuite.setup());
	}
