...
public class DocumentsApiSdkClientCredentialUserTest extends AbstractSdkClientCredentialUserTestSuite {

	private final DocumentsApi documentsApi = new DocumentsApi(null);

	public DocumentsApiSdkClientCredentialUserTest() {
		documentsApi.setContext(AbstractSdkClientCredentialUserTestSuite.setup());
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Documents\\getDocuments.csv")
	public void getDocumentswithGzip(String testCaseId, String testCaseName, String keyword, String accountId,
			String docType, String fromDate, String toDate, String enabled) {
		DocumentsApiSdkTest.getDocumentsTestwithGzip(documentsApi, testCaseId, testCaseName, keyword, accountId,
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Documents\\downloadDocuments.csv")
	public void downloadDocumentwithGzip(String testCaseId, String testCaseName, String documentId, String enabled) {
		DocumentsApiSdkTest.downloadDocumentTest(documentsApi, testCaseId, testCaseName, documentId);
	}
