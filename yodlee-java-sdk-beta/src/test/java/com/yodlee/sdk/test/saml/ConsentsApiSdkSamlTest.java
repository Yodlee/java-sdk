...
public class ConsentsApiSdkSamlTest  extends AbstractSdkSAMLUserTestSuite {
	
	private final ConsentsApi consentsApi = new ConsentsApi(null);

	public ConsentsApiSdkSamlTest() {
		consentsApi.setContext(AbstractSdkSAMLUserTestSuite.setup());
	}
