...
public class ProvidersApiSdkJwtTest extends AbstractSdkJWTCobrandTestSuite {

	private static final ProvidersApi providersApi = new ProvidersApi(null);

	public ProvidersApiSdkJwtTest() throws ApiException {
		providersApi.setContext(AbstractSdkJWTCobrandTestSuite.setup());
	}
	...
	public void getAllProvidersTest(String testCaseId, String testCaseName, String capability, //
			...
			Integer skip, Integer top, String fullAccountNumberFields, String enabled) {
	...
	public void getAllProvidersAsyncTest(String testCaseId, String testCaseName, String capability, //
		...
		ProvidersApiSdkTest.getAllProvidersAsyncTest(providersApi, testCaseId, testCaseName, capability, datasetFilter,
				name, priority, skip, top, fullAccountNumberFields);
	}
