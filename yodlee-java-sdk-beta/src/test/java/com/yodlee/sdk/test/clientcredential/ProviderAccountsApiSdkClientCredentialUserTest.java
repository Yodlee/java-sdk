...
public class ProviderAccountsApiSdkClientCredentialUserTest extends AbstractSdkClientCredentialUserTestSuite {

	ProviderAccountsApi providerAccountsApi = new ProviderAccountsApi(null);

	public ProviderAccountsApiSdkClientCredentialUserTest() {
		providerAccountsApi.setContext(AbstractSdkClientCredentialUserTestSuite.setup());
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\ProviderAccounts\\getProviderAccount.csv")
	public void getProviderAccountTestwithGzip(String testCaseId, String testCaseName, Long providerAccountId,
			String include, String requestId, String enabled) {
		ProviderAccountsApiSdkTest.getProviderAccountTestwithGzip(providerAccountsApi, testCaseId, testCaseName,
				providerAccountId, include, requestId);
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\ProviderAccounts\\getAllProviderAccounts.csv")
	public void getAllProviderAccountsTestwithGzip(String testCaseId, String testCaseName, String include, String providerIds,
			String enabled) {
		ProviderAccountsApiSdkTest.getAllProviderAccountsTestwithGzip(providerAccountsApi, testCaseId, testCaseName, include,
				providerIds);
	}
	 ...
	 */
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\ProviderAccounts\\linkProviderAccountOB.csv")
	public void linkProviderAccountOBTest(String testCaseId, String testCaseName, long providerId, String fileName,
			String enabled) {
		ProviderAccountsApiSdkTest.linkProviderAccountTest(providerAccountsApi, testCaseId, testCaseName, providerId,
				fileName);
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\ProviderAccounts\\updateProviderAccountOB.csv")
	public void updateProviderAccountOBTest(String testCaseId, String testCaseName, String providerAccountsId,
			String fileName, String enabled) {
		ProviderAccountsApiSdkTest.updateProviderAccount(providerAccountsApi, testCaseId, testCaseName,
				providerAccountsId, fileName);
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\ProviderAccounts\\updateProviderAccountOB.csv")
	public void refreshProviderAccountOBTest(String testCaseId, String testCaseName, String providerAccountId,
			String fileName, String enabled) {
		ProviderAccountsApiSdkTest.refreshProviderAccountTest(providerAccountsApi, testCaseId, testCaseName,
				providerAccountId, fileName);
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\ProviderAccounts\\updateProviderAccountOB.csv")
	public void refreshAllProviderAccountsOBTest(String testCaseId, String testCaseName, String providerAccountIds,
			String fileName, String enabled) {
		ProviderAccountsApiSdkTest.refreshAllProviderAccountsTest(providerAccountsApi, testCaseId, testCaseName,
				providerAccountIds, fileName);
	}
