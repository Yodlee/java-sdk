...
public class TransactionsApiSdkClientCredentialUserTest extends AbstractSdkClientCredentialUserTestSuite {

	private final TransactionsApi transactionsApi = new TransactionsApi(null);

	public TransactionsApiSdkClientCredentialUserTest() {
		transactionsApi.setContext(AbstractSdkClientCredentialUserTestSuite.setup());
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Transactions\\getTransactions.csv")
	public void getTransactionswithGzip(String testCaseId, String testCaseName, String accountId, String baseType,
			String categoryId, String categoryType, String container, String detailCategoryId, String fromDate,
			String highLevelCategoryId, String keyword, String skip, String toDate, String top, String type,
			String enabled) {
		TransactionsApiSdkTest.getTransactionsTestwithGzip(transactionsApi, testCaseId, testCaseName, accountId,
				baseType, categoryId, categoryType, container, detailCategoryId, fromDate, highLevelCategoryId, keyword,
				skip, toDate, top, type);
	}
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Transactions\\createTransactionCategory.csv")
	public void createTransactionCategoryAsync(String testCaseId, String testCaseName, String fileName,
			String enabled) {
