...
public class VerificationApiSdkJwtTest extends AbstractSdkJWTUserTestSuite {
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\Verification\\getVerifiedAccounts.csv")
	public void getVerifiedAccounts(String testCaseId, String testCaseName,  String providerAccountId, String accountId, String isSelected, String verificationStatus, String enabled) {
		VerificationApiSdkTest.getVerifiedAccounts(verificationApi, testCaseId, testCaseName,  providerAccountId, accountId, isSelected, verificationStatus);
	}
}
