...
3.Registers a user. Please note that user registeration is a one-time activity, hence to re-run the application, either comment registerUser method call or change the userLoginName in sampleAppResources.json to register a new user. 
