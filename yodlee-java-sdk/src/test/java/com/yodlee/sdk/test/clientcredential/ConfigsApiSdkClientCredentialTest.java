...
public class ConfigsApiSdkClientCredentialTest extends AbstractSdkClientCredentialAppTestSuite {

	private static final ConfigsApi configsApi = new ConfigsApi(null);

	public ConfigsApiSdkClientCredentialTest() {
		configsApi.setContext(AbstractSdkClientCredentialAppTestSuite.setup());
	}
	...
	public void subscribeNotificationEventUsingPOSTTest(String testCaseId, String testCaseName, String fileName, String eventName,
			String enabled) {
	...
	public void updateSubscriptionNotificationUsingPUTTest(String testCaseId, String testCaseName, String fileNametoSubcribe,
			String fileName, String eventName, String enabled) {
		ConfigsApiSdkTest.testUpdateSubsribedNotificationEvent(configsApi, testCaseId, testCaseName, fileNametoSubcribe, fileName,
				eventName);
	}
	...
	public void deleteSubscriptionNotificationUsingDELETETest(String testCaseId, String testCaseName, String fileName,
			String eventName, String enabled) {
		ConfigsApiSdkTest.testDeleteSubsribeNotificationEvent(configsApi, testCaseId, testCaseName, fileName, eventName);
	}
}
