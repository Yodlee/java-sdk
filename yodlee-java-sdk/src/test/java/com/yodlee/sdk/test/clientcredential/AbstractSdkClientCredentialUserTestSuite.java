...
public abstract class AbstractSdkClientCredentialUserTestSuite extends FeedTest {
	...
	protected static ClientCredentialUserContext setup() {
		ClientCredentialUserContextBuilder clientCredentialContextBuilder = ContextBuilderFactory.createClientCredentialUserContextBuilder();
		ClientCredentialUserContext clientCredentialContext = null;
		try (InputStream inStream =
				AbstractSdkClientCredentialAppTestSuite.class.getResourceAsStream("/configuration/clientCredentialUser.properties");) {
