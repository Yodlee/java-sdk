...
public class TransactionsApiSdkSamlTest extends AbstractSdkSAMLUserTestSuite {

	private final TransactionsApi transactionsApi = new TransactionsApi(null);

	public TransactionsApiSdkSamlTest() {
		transactionsApi.setContext(AbstractSdkSAMLUserTestSuite.setup());
	}
