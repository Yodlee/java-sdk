...
public class VerifyAccountApiSdkTest {
	...
	public static void getVerifyAccountUsingPOSTTest(VerifyAccountApi verifyAccountApi , String testCaseId, String testCaseName, String fileName, Long providerAccountId) {
		try {
			VerifyAccountRequest verifyAccountRequest = ModelUtil.load(fileName, VerifyAccountRequest.class);
			ApiResponse<VerifyAccountResponse> verifyAccountsResponse = verifyAccountApi.verifyAccounts(providerAccountId, verifyAccountRequest);
