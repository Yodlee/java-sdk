...
public class ConfigsApiSdkTest {
	...
	public static void testSubsribeNotificationEvent(ConfigsApi configsApi, String testCaseId, String testCaseName, String fileName,
			String eventName) {
		...
		try {
			...
			ApiResponse<AbstractModelComponent> subribeEvent =
					configsApi.createSubscriptionNotificationEvent(ConfigsNotificationEventType.valueOf(eventName), eventRequest);
	...
	public static void testGetSubsribedNotificationEvent(ConfigsApi configsApi, String testCaseId, String testCaseName,
		...
		try {
			...
			ApiResponse<ConfigsNotificationResponse> subscribedEventsWithNoVAlue = configsApi.getSubscribedNotificationEvents(null);
	...
	public static void testUpdateSubsribedNotificationEvent(ConfigsApi configsApi, String testCaseId, String testCaseName,
		...
		try {
			...
			subscribeNotificationEvent(configsApi, eventName, eventRequest);
			//
			ApiResponse<AbstractModelComponent> updateEvent = configsApi
					.updateSubscribedNotificationEvent(ConfigsNotificationEventType.valueOf(eventName), updateEventRequest);
			PrintUtil.printJSONResponse(testCaseId, testCaseName, null);
	...
	public static void testDeleteSubsribeNotificationEvent(ConfigsApi configsApi, String testCaseId, String testCaseName,
			String fileName, String eventName) {
