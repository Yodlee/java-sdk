...
public class ConfigsApiSdkSamlTest extends AbstractSdkSAMLCobrandTestSuite {

	private static final ConfigsApi configsApi = new ConfigsApi(null);

	public ConfigsApiSdkSamlTest() throws ApiException {
		configsApi.setContext(AbstractSdkSAMLCobrandTestSuite.setup());
	}
