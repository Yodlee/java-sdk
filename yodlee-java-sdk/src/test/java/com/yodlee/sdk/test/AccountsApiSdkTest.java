...
public class AccountsApiSdkTest {
	...
	public static void getAccountDetailsTest(AccountsApi accountsApi, String testCaseId, String testCaseName,
			String accountId, String container, String include) {
		try {
			...
			ApiResponse<AccountResponse> accountDetails =
					accountsApi.getAccount(accountIdAccounts, accountsContainer, includeValue);
	...
	public static void getAllAccountsTest(AccountsApi accountsApi, String testCaseId, String testCaseName,
		...
		try {
			...
			Long[] providerAccountIdValue = StringUtils.isBlank(providerAccountId) ? null : convertStringtoLongArray(providerAccountId);
			IncludeParameterValue[] includeValue = includeParameterValuesList.toArray(new IncludeParameterValue[0]);
			ApiResponse<AccountResponse> allAccounts = accountsApi.getAllAccounts(accountIdValue,
					accountsContainer, includeValue, providerAccountIdValue, requestId, statusValue);
	...
	public static void getHistoricalBalancesTest(AccountsApi accountsApi, String testCaseId, String testCaseName,
		...
		try {
			...
			HistoricalBalancesIntervalValue intervalValue = StringUtils.isBlank(interval) ? null : HistoricalBalancesIntervalValue.valueOf(interval);
			...
			ApiResponse<AccountHistoricalBalancesResponse> historicalBalances = accountsApi.getHistoricalBalances(
					accountIdAccounts, toDateValue, fromDateValue, accountIncludeCF, intervalValue, skipValue, topValue);
