...
public class ProviderAccountsApiSdkSamlTest extends AbstractSdkSAMLUserTestSuite {

	ProviderAccountsApi providerAccountsApi = new ProviderAccountsApi(null);

	public ProviderAccountsApiSdkSamlTest() {
		providerAccountsApi.setContext(AbstractSdkSAMLUserTestSuite.setup());
	}
