...
public class ConsentsApiSdkClientCredentialUserTest  extends AbstractSdkClientCredentialUserTestSuite {
	
	private final ConsentsApi consentsApi = new ConsentsApi(null);

	public ConsentsApiSdkClientCredentialUserTest() {
		consentsApi.setContext(AbstractSdkClientCredentialUserTestSuite.setup());
	}
